    ...
    public function store(Request $request)
    {
        ...
        foreach ($fechasAgenda as $fechaCita) {
            ...
            $cita = Cita::create([
                ...
                'cobro_anticipado' => $recurrencia !== 'ninguna' && $fechaCita === ($fechasAgenda[0] ?? null),
                'sesiones_cobradas' => $recurrencia !== 'ninguna' && $fechaCita === ($fechasAgenda[0] ?? null) ? count($fechasAgenda) : 1,
                'excluir_finanzas' => $recurrencia !== 'ninguna' && $fechaCita !== ($fechasAgenda[0] ?? null),
